            ...
            <div class="box-body">
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td><img src="{{$item['userInfo']['avatarUrl']}}" style="width:48px;height:48px;border-radius:50%;"/></td>
                        <td>{{$item['source_lan']}}</td>
                        <td>{{$item['target_lan']}}</td>
                        <td>{{$item['source_con']}}</td>
                        <td>{{$item['target_con']}}</td>
